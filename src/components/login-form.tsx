      ...
      <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-3xl shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-800 animate-in zoom-in-95 duration-500">
        ...
        <div className="p-8 md:p-10">
          <header className="text-center mb-8">
            <div className="w-16 h-16 rounded-2xl mx-auto overflow-hidden shadow-xl shadow-indigo-600/30 mb-6 transition-transform hover:scale-105 bg-white dark:bg-slate-900 relative">
              {/* Spinning Rings */}
          ...
          {mode === 'login' && (
            <div className="space-y-6">
              ...
              <div className="text-center pt-4">
                <p className="text-sm font-bold text-slate-500 dark:text-slate-400 capitalize tracking-wide">
                  New here?{" "}
                  <Link
                    href="/register"
          ...
          {(mode === 'forgot' || mode === 'reset') && (
            <form onSubmit={handleAuth} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 py-4 rounded-xl font-bold transition-all active:scale-[0.98] disabled:opacity-50 mt-4 border border-transparent hover:border-slate-300 dark:hover:border-slate-600 flex items-center justify-center font-bold"
              >
                {isLoading ? (
              ...
              <div className="text-center mt-4">
                <button
                  ...
                  className="text-sm font-bold text-slate-500 hover:text-indigo-600 dark:text-slate-400 dark:hover:text-indigo-400 transition-all flex items-center justify-center gap-2 mx-auto"
                >
